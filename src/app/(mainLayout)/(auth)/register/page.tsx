...
//     try {
//       // এপিআই-তে ডাটা পোস্ট করা হচ্ছে
//       const response = await axios.post(`${BASE_URL}/auth/register`, formData, {
//         withCredentials: true,
//       });

//       // ৪. কনসোলে ডাটা প্রিন্ট করা (তোমার রিকোয়েস্ট অনুযায়ী)
//       console.log("Registration Success Data:", response.data);

//       if (response.data.success) {
//         toast.success("Account created successfully!", { id: loadId });

//         // রেজিস্ট্রেশন সফল হলে লগইন পেজে পাঠিয়ে দেওয়া হচ্ছে
//         router.push("/login");
//       }
//     } catch (error: any) {
...
const Register = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        // ৩. রেজিস্ট্রেশন সফল হলে স্টেটে ইউজার ডাটা সেট করো
        const userData = response.data.data;
        loginUser(userData);

        toast.success("Account created successfully!", { id: loadId });

        // ৪. রোল অনুযায়ী রিডাইরেক্ট করো
